  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="search.php">
        <input type="text" name="query" placeholder="Search" id="idnum" onkeyup='saveValue(this);' title="Enter search keyword">
...
<?php
	if(isset($_POST['btn'])){
    $tit = $_POST['query'];
    $sql2 = "SELECT * FROM student_tbl WHERE student_fname LIKE '%$tit%' OR student_mname LIKE '%$tit%' OR student_lname LIKE '%$tit%' OR student_id LIKE '%$tit%'  OR student_course LIKE '%$tit%'";
    ...
    ?>
				 <tbody>
                  <tr>
                    ...
                    <td><a  href="edit_view_student.php?edit=<?php echo $s_id?>">Edit</a></td>
                    <td><a  href="view_records.php?view=<?php echo $s_id?>">View Record(s)</a></td>
                    <td><a  href="edit_view_student.php?edit=<?php echo $s_id?>">Archive</a></td>
                  </tr>
                 <?php }
}
	else{
