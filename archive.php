...
<section class="section">
    ...
    <div class="col-lg-6">
             ...
             <div class="card-body">
              ...
              <?php
$sql = "SELECT * FROM student_tbl WHERE status = 'Archived'";
  ...
  ?>
                <tbody>
                  <tr>
                    ...
                    <td><a  href="stud_rec.php?view=<?php echo $s_id?>">View Record(s)</a></td>
                    <!-- <td><a  href="popup-page/arch_stud.php?archive=<?php echo $s_id?>">Archive</a></td> -->
                  </tr>
                  <?php  
          }
        }
